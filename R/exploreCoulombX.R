...
# Read the Coulomb Matrix
CoulombMatrix <- fread("../data/coulombX.csv", header = FALSE)
...
combined <- merge(CoulombMatrix, outcomesAe, by="Id")
...
# RMSE
sqrt(mean((pred - test.Y)^2)) # 0.1164569
